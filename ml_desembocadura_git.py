...
# Variable a predecir
caudal_shift_6['mean_H06A18DesembocRblaAlbujon'] = resampleado_caudal['mean_H06A18DesembocRblaAlbujon']


# Mejor resultado antes de std desviation, con 6 shift y con rolados 6, 12 y 18. Sin selección de variables
result = pd.concat([caudal_shift_6, pluviometros_shift_6, Piezometrico_shift_6, rolado_caudal_6, rolado_caudal_12, rolado_caudal_18, rolado_caudal_24,
                    rolado_pluvios_6,  rolado_pluvios_12, rolado_pluvios_18, rolado_pluvios_24, rolado_Piezometrico_6, rolado_Piezometrico_12, rolado_Piezometrico_18, rolado_Piezometrico_24], axis=1)
...
X = result_sinna.drop('mean_H06A18DesembocRblaAlbujon',  axis=1)
y = result_sinna['mean_H06A18DesembocRblaAlbujon']
...
df_final_arurora["mean_H06A18DesembocRblaAlbujon"] = result_sinna['mean_H06A18DesembocRblaAlbujon']
...
datos_entrenamiento.to_csv('../acg_paper/Desem_train_100variables.csv')
datos_prueba.to_csv('../acg_paper/Desem_test_100variables.csv')
...
for split_num in range(1, n_splits + 1):
    ...
    plt.legend()
    plt.savefig(f'../acg_paper/Desem_k100_KNeighborsRegressor_Split_{split_num}.png')
    plt.show()
...
errors_df.to_csv('../acg_paper/Desem_k100_KNeighborsRegressor_errors_table.csv', index=False, float_format='%.4f') 
...
for split_num in range(1, n_splits + 1):
    ...
    plt.ylabel('Streamflow')
    plt.legend()
    plt.savefig(f'../acg_paper/Desem_k100_LinearRegression_Split_{split_num}.png')
    plt.show()
...
errors_df.to_csv('../acg_paper/Desem_k100_LinearRegression_errors_table.csv', index=False, float_format='%.4f') 
...
for split_num in range(1, n_splits + 1):
    ...
    plt.ylabel('Streamflow')
    plt.legend()
    plt.savefig(f'../acg_paper/Desem_k100_GradientBoostingRegressor_Split_{split_num}.png')
    plt.show()
...
errors_df.to_csv('../acg_paper/Desem_k100_GradientBoostingRegressor_errors_table.csv', index=False, float_format='%.4f') 
...
for split_num in range(1, n_splits + 1):
    ...
    plt.ylabel('Streamflow')
    plt.legend()
    plt.savefig(f'../acg_paper/Desem_k100_RandomForestRegressor_Split_{split_num}.png')
    plt.show()
...
errors_df.to_csv('../acg_paper/Desem_k100_RandomForestRegressor_errors_table.csv', index=False, float_format='%.4f') 
...
for split_num in range(1, n_splits + 1):
    ...
    plt.ylabel('Streamflow')
    plt.legend()
    plt.savefig(f'../acg_paper/Desem_k100_DecisionTreeRegressor_Split_{split_num}.png')
    plt.show()
...
errors_df.to_csv('../acg_paper/Desem_k100_DecisionTreeRegressor_errors_table.csv', index=False, float_format='%.4f') 
...
for split_num in range(1, n_splits + 1):
    ...
    plt.ylabel('Streamflow')
    plt.legend()
    plt.savefig(f'../acg_paper/Desem_k100_Ridge_Split_{split_num}.png')
    plt.show()
...
errors_df.to_csv('../acg_paper/Desem_k100_Ridge_errors_table.csv', index=False, float_format='%.4f') 
...
for split_num in range(1, n_splits + 1):
    ...
    plt.ylabel('Streamflow')
    plt.legend()
    plt.savefig(f'../acg_paper/Desem_k100_XGBRegressor_Split_{split_num}.png')
    plt.show()
...
errors_df.to_csv('../acg_paper/Desem_k100_XGBRegressor_errors_table.csv', index=False, float_format='%.4f') 
...
resampleado_caudal_12h = resampleado_caudal.copy()
resampleado_caudal_12h['mean_H06A18DesembocRblaAlbujon_12h'] = resampleado_caudal_12h['mean_H06A18DesembocRblaAlbujon'].shift(-12)
...
result = pd.concat([resampleado_caudal_12h['mean_H06A18DesembocRblaAlbujon_12h'], caudal_shift_6, pluviometros_shift_6, Piezometrico_shift_6, rolado_caudal_6, 
...
X = result_sinna.drop('mean_H06A18DesembocRblaAlbujon_12h',  axis=1)
y = result_sinna['mean_H06A18DesembocRblaAlbujon_12h']
...
result = pd.concat([resampleado_caudal_12h['mean_H06A18DesembocRblaAlbujon_12h'], caudal_shift_6, pluviometros_shift_6, Piezometrico_shift_6, rolado_caudal_6, rolado_caudal_12, rolado_caudal_18, rolado_caudal_24,
                    rolado_pluvios_6,  rolado_pluvios_12, rolado_pluvios_18, rolado_pluvios_24, rolado_Piezometrico_6, rolado_Piezometrico_12, rolado_Piezometrico_18, rolado_Piezometrico_24], axis=1)
...
df_final_arurora["mean_H06A18DesembocRblaAlbujon_12h"] = result_sinna['mean_H06A18DesembocRblaAlbujon_12h']
...
datos_entrenamiento.to_csv('../acg_paper/12h_Desem_train_100variables.csv')
datos_prueba.to_csv('../acg_paper/12h_Desem_test_100variables.csv')
...
for split_num in range(1, n_splits + 1):
    ...
    plt.ylabel('Streamflow')
    plt.legend()
    plt.savefig(f'../acg_paper/12H_Desem_k100_KNeighborsRegressor_Split_{split_num}.png')
    plt.show()
...
errors_df.to_csv('../acg_paper/12H_Desem_k100_KNeighborsRegressor_errors_table.csv', index=False, float_format='%.4f') 
...
for split_num in range(1, n_splits + 1):
    ...
    plt.ylabel('Streamflow')
    plt.legend()
    plt.savefig(f'../acg_paper/12H_Desem_k100_LinearRegression_Split_{split_num}.png')
    plt.show()
...
errors_df.to_csv('../acg_paper/12H_Desem_k100_LinearRegression_errors_table.csv', index=False, float_format='%.4f') 
...
for split_num in range(1, n_splits + 1):
    ...
    plt.ylabel('Streamflow')
    plt.legend()
    plt.savefig(f'../acg_paper/12H_Desem_k100_GradientBoostingRegressor_Split_{split_num}.png')
    plt.show()
...
errors_df.to_csv('../acg_paper/12H_Desem_k100_GradientBoostingRegressor_errors_table.csv', index=False, float_format='%.4f') 
...
for split_num in range(1, n_splits + 1):
    ...
    plt.ylabel('Streamflow')
    plt.legend()
    plt.savefig(f'../acg_paper/12H_Desem_k100_RandomForestRegressor_Split_{split_num}.png')
    plt.show()
...
errors_df.to_csv('../acg_paper/12H_Desem_k100_RandomForestRegressor_errors_table.csv', index=False, float_format='%.4f') 
...
for split_num in range(1, n_splits + 1):
    ...
    plt.ylabel('Streamflow')
    plt.legend()
    plt.savefig(f'../acg_paper/12H_Desem_k100_DecisionTreeRegressor_Split_{split_num}.png')
    plt.show()
...
errors_df.to_csv('../acg_paper/12H_Desem_k100_DecisionTreeRegressor_errors_table.csv', index=False, float_format='%.4f') 
...
for split_num in range(1, n_splits + 1):
    ...
    plt.ylabel('Streamflow')
    plt.legend()
    plt.savefig(f'../acg_paper/12H_Desem_k100_Ridge_Split_{split_num}.png')
    plt.show()
...
errors_df.to_csv('../acg_paper/12H_Desem_k100_Ridge_errors_table.csv', index=False, float_format='%.4f') 
...
for split_num in range(1, n_splits + 1):
    ...
    plt.ylabel('Streamflow')
    plt.legend()
    plt.savefig(f'../acg_paper/12H_Desem_k100_XGBRegressor_Split_{split_num}.png')
    plt.show()
...
errors_df.to_csv('../acg_paper/12H_Desem_k100_XGBRegressor_errors_table.csv', index=False, float_format='%.4f') 
...
resampleado_caudal_24h['mean_H06A18DesembocRblaAlbujon_24h'] = resampleado_caudal_24h['mean_H06A18DesembocRblaAlbujon'].shift(-24)
...
result = pd.concat([resampleado_caudal_24h['mean_H06A18DesembocRblaAlbujon_24h'], caudal_shift_6, pluviometros_shift_6, Piezometrico_shift_6, rolado_caudal_6, 
                    rolado_caudal_12, rolado_caudal_18, rolado_caudal_24, rolado_pluvios_6,  rolado_pluvios_12, rolado_pluvios_18, rolado_pluvios_24,
                    rolado_Piezometrico_6, rolado_Piezometrico_12, rolado_Piezometrico_18, rolado_Piezometrico_24], axis=1)
...
X = result_sinna.drop('mean_H06A18DesembocRblaAlbujon_24h',  axis=1)
y = result_sinna['mean_H06A18DesembocRblaAlbujon_24h']
...
result = pd.concat([resampleado_caudal_24h['mean_H06A18DesembocRblaAlbujon_24h'], caudal_shift_6, pluviometros_shift_6, Piezometrico_shift_6, rolado_caudal_6, rolado_caudal_12, rolado_caudal_18, rolado_caudal_24,
                    rolado_pluvios_6,  rolado_pluvios_12, rolado_pluvios_18, rolado_pluvios_24, rolado_Piezometrico_6, rolado_Piezometrico_12, rolado_Piezometrico_18, rolado_Piezometrico_24], axis=1)
...
df_final_arurora["mean_H06A18DesembocRblaAlbujon_24h"] = result_sinna['mean_H06A18DesembocRblaAlbujon_24h']
...
datos_entrenamiento.to_csv('../acg_paper/24h_Desem_train_100variables.csv')
datos_prueba.to_csv('../acg_paper/24h_Desem_test_100variables.csv')
...
for split_num in range(1, n_splits + 1):
    ...
    plt.ylabel('Streamflow')
    plt.legend()
    plt.savefig(f'../acg_paper/24h_Desem_k100_KNeighborsRegressor_Split_{split_num}.png')
    plt.show()
...
errors_df.to_csv('../acg_paper/24h_Desem_k100_KNeighborsRegressor_errors_table.csv', index=False, float_format='%.4f') 
...
for split_num in range(1, n_splits + 1):
    ...
    plt.ylabel('Streamflow')
    plt.legend()
    plt.savefig(f'../acg_paper/24h_Desem_k100_LinearRegression_Split_{split_num}.png')
    plt.show()
...
errors_df.to_csv('../acg_paper/24h_Desem_k100_LinearRegression_errors_table.csv', index=False, float_format='%.4f') 
...
for split_num in range(1, n_splits + 1):
    ...
    plt.ylabel('Streamflow')
    plt.legend()
    plt.savefig(f'../acg_paper/24h_Desem_k100_GradientBoostingRegressor_Split_{split_num}.png')
    plt.show()
...
errors_df.to_csv('../acg_paper/24h_Desem_k100_GradientBoostingRegressor_errors_table.csv', index=False, float_format='%.4f') 
...
for split_num in range(1, n_splits + 1):
    ...
    plt.ylabel('Streamflow')
    plt.legend()
    plt.savefig(f'../acg_paper/24H_Desem_k100_RandomForestRegressor_Split_{split_num}.png')
    plt.show()
...
errors_df.to_csv('../acg_paper/24h_Desem_k100_RandomForestRegressor_errors_table.csv', index=False, float_format='%.4f') 
...
for split_num in range(1, n_splits + 1):
    ...
    plt.ylabel('Streamflow')
    plt.legend()
    plt.savefig(f'../acg_paper/24h_Desem_k100_DecisionTreeRegressor_Split_{split_num}.png')
    plt.show()
...
errors_df.to_csv('../acg_paper/24h_Desem_k100_DecisionTreeRegressor_errors_table.csv', index=False, float_format='%.4f') 
...
for split_num in range(1, n_splits + 1):
    ...
    plt.ylabel('Streamflow')
    plt.legend()
    plt.savefig(f'../acg_paper/24h_Desem_k100_Ridge_Split_{split_num}.png')
    plt.show()
...
errors_df.to_csv('../acg_paper/24h_Desem_k100_Ridge_errors_table.csv', index=False, float_format='%.4f') 
...
for split_num in range(1, n_splits + 1):
    ...
    plt.ylabel('Streamflow')
    plt.legend()
    plt.savefig(f'../acg_paper/24h_Desem_k100_XGBRegressor_Split_{split_num}.png')
    plt.show()
...
errors_df.to_csv('../acg_paper/24h_Desem_k100_XGBRegressor_errors_table.csv', index=False, float_format='%.4f') 