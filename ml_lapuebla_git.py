...
# Variable a predecir
caudal_shift_6['mean_H06A01LaPuebla'] = resampleado_caudal['mean_H06A01LaPuebla']
...
X = result_sinna.drop('mean_H06A01LaPuebla',  axis=1)
y = result_sinna['mean_H06A01LaPuebla']
...
df_final_arurora["mean_H06A01LaPuebla"] = result_sinna['mean_H06A01LaPuebla']
...
datos_entrenamiento.to_csv('../acg_paper/train_100variables.csv')
datos_prueba.to_csv('../acg_paper/test_100variables.csv')
...
for split_num in range(1, n_splits + 1):
    ...
    plt.legend()
    plt.savefig(f'../acg_paper/puebla_k100_KNeighborsRegressor_Split_{split_num}.png')
    plt.show()
...
errors_df.to_csv('../acg_paper/puebla_k100_KNeighborsRegressor_errors_table.csv', index=False, float_format='%.4f') 
...
for split_num in range(1, n_splits + 1):
    ...
    plt.ylabel('Streamflow')
    plt.legend()
    plt.savefig(f'../acg_paper/puebla_k100_LinearRegression_Split_{split_num}.png')
    plt.show()
...
errors_df.to_csv('../acg_paper/puebla_k100_LinearRegression_errors_table.csv', index=False, float_format='%.4f') 
...
for split_num in range(1, n_splits + 1):
    ...
    plt.ylabel('Streamflow')
    plt.legend()
    plt.savefig(f'../acg_paper/puebla_k100_GradientBoostingRegressor_Split_{split_num}.png')
    plt.show()
...
errors_df.to_csv('../acg_paper/puebla_k100_GradientBoostingRegressor_errors_table.csv', index=False, float_format='%.4f') 
...
#shap values
# Inicializa el explainer de SHAP con el modelo entrenado y los datos de entrenamiento
...
# Summary plot of SHAP values for the test set
#shap.summary_plot(shap_values_test, feature_names=nombres_columnas)

#plt.savefig('../acg_paper/shap_rf.png', dpi=600)

#plt.show()

#shap.plots.waterfall(shap_values_test)

#plt.savefig('../acg_paper/shap_rf_waterfall.png', dpi=600)
...
for split_num in range(1, n_splits + 1):
    ...
    plt.ylabel('Streamflow')
    plt.legend()
    plt.savefig(f'../acg_paper/puebla_k100_RandomForestRegressor_Split_{split_num}.png')
    plt.show()
...
errors_df.to_csv('../acg_paper/puebla_k100_RandomForestRegressor_errors_table.csv', index=False, float_format='%.4f') 
...
for split_num in range(1, n_splits + 1):
    ...
    plt.ylabel('Streamflow')
    plt.legend()
    plt.savefig(f'../acg_paper/puebla_k100_DecisionTreeRegressor_Split_{split_num}.png')
    plt.show()
...
errors_df.to_csv('../acg_paper/puebla_k100_DecisionTreeRegressor_errors_table.csv', index=False, float_format='%.4f') 
...
for split_num in range(1, n_splits + 1):
    ...
    plt.ylabel('Streamflow')
    plt.legend()
    plt.savefig(f'../acg_paper/puebla_k100_Ridge_Split_{split_num}.png')
    plt.show()
...
errors_df.to_csv('../acg_paper/puebla_k100_Ridge_errors_table.csv', index=False, float_format='%.4f') 
...
for split_num in range(1, n_splits + 1):
    ...
    plt.ylabel('Streamflow')
    plt.legend()
    plt.savefig(f'../acg_paper/puebla_k100_XGBRegressor_Split_{split_num}.png')
    plt.show()
...
errors_df.to_csv('../acg_paper/puebla_k100_XGBRegressor_errors_table.csv', index=False, float_format='%.4f') 
...
resampleado_caudal_12h['mean_H06A01LaPuebla_12h'] = resampleado_caudal_12h['mean_H06A01LaPuebla'].shift(-12)
...
# Mejor resultado antes de std desviation, con 6 shift y con rolados 6, 12 y 18. Sin selección de variables
result = pd.concat([resampleado_caudal_12h['mean_H06A01LaPuebla_12h'], caudal_shift_6, pluviometros_shift_6, Piezometrico_shift_6, rolado_caudal_6, 
...
X = result_sinna.drop('mean_H06A01LaPuebla_12h',  axis=1)
y = result_sinna['mean_H06A01LaPuebla_12h']
...
df_final_arurora["mean_H06A01LaPuebla_12h"] = result_sinna['mean_H06A01LaPuebla_12h']
...
datos_entrenamiento.to_csv('../acg_paper/12h_train_100variables.csv')
datos_prueba.to_csv('../acg_paper/12h_test_100variables.csv')
...
for split_num in range(1, n_splits + 1):
    ...
    plt.ylabel('Values')
    plt.legend()
    plt.savefig(f'../acg_paper/12h_k100_KNeighborsRegressor_Split_{split_num}.png')
    plt.show()
...
errors_df.to_csv('../acg_paper/12Hpuebla_k100_KNeighborsRegressor_errors_table.csv', index=False, float_format='%.4f') 
...
for split_num in range(1, n_splits + 1):
    ...
    plt.ylabel('Values')
    plt.legend()
    plt.savefig(f'../acg_paper/12h_k100_LinearRegression_Split_{split_num}.png')
    plt.show()
...
errors_df.to_csv('../acg_paper/12h_k100_LinearRegression_errors_table.csv', index=False, float_format='%.4f') 
...
for split_num in range(1, n_splits + 1):
    ...
    plt.ylabel('Values')
    plt.legend()
    plt.savefig(f'../acg_paper/12h_k100_GradientBoostingRegressor_Split_{split_num}.png')
    plt.show()
...
errors_df.to_csv('../acg_paper/12h_k100_GradientBoostingRegressor_errors_table.csv', index=False, float_format='%.4f') 
...
for split_num in range(1, n_splits + 1):
    ...
    plt.ylabel('Values')
    plt.legend()
    plt.savefig(f'../acg_paper/12h_k100_RandomForestRegressor_Split_{split_num}.png')
    plt.show()
...
errors_df.to_csv('../acg_paper/12h_k100_RandomForestRegressor_errors_table.csv', index=False, float_format='%.4f') 
...
for split_num in range(1, n_splits + 1):
    ...
    plt.ylabel('Values')
    plt.legend()
    plt.savefig(f'../acg_paper/12h_k100_DecisionTreeRegressor_Split_{split_num}.png')
    plt.show()
...
errors_df.to_csv('../acg_paper/12h_k100_DecisionTreeRegressor_errors_table.csv',index=False, float_format='%.4f') 
...
for split_num in range(1, n_splits + 1):
    ...
    plt.ylabel('Values')
    plt.legend()
    plt.savefig(f'../acg_paper/12h_k100_Ridge_Split_{split_num}.png')
    plt.show()
...
errors_df.to_csv('../acg_paper/12h_k100_Ridge_errors_table.csv', index=False, float_format='%.4f') 
...
for split_num in range(1, n_splits + 1):
    ...
    plt.ylabel('Values')
    plt.legend()
    plt.savefig(f'../acg_paper/12h_k100_XGBRegressor_Split_{split_num}.png')
    plt.show()
...
errors_df.to_csv('../acg_paper/12h_k100_XGBRegressor_errors_table.csv', index=False, float_format='%.4f') 
